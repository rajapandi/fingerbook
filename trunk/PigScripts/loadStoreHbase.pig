...
data1 = FOREACH amounts1 GENERATE FLATTEN($0) as (v2:chararray, v1:chararray);
edges = FOREACH data1 GENERATE $1, $0;
...
data2 = FOREACH amounts2 GENERATE FLATTEN($0) as (v2:chararray, v1:chararray);
edges_dup = FOREACH data2 GENERATE $1, $0;
